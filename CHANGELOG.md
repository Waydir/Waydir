...
- Sort button in the status bar and a sort menu in the background context menu, so sorting works in grid view too.
...
[Unreleased]: https://github.com/Waydir/Waydir/compare/v0.16.0...HEAD
